...
class Kidberries_Widget_Cart extends WP_Widget {
	 ...
	 * @return void
	 */
	function Kidberries_Widget_Cart() {

		/* Widget variable settings. */
		$this->woo_widget_cssclass 		= 'kidberries widget_shopping_cart';
		$this->woo_widget_description 	= __( "Display the user's Cart in the sidebar.", 'woocommerce' );
		$this->woo_widget_idbase 		= 'kidberries_widget_cart';
		$this->woo_widget_name 			= __( 'Kidberries Cart', 'woocommerce' );
