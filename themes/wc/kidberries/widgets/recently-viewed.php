...
class Kidberries_WC_Widget_Recently_Viewed extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		if ( $r->have_posts() ) {
			...
			echo '<div class="block-content"><ol id="recently-viewed-items">';

			while ( $r->have_posts()) {
				$r->the_post();
				global $product;

				echo '<li class="item last odd">
					<p class="product-name"><a href="' . get_permalink() . '">
						' . get_the_title() . '
					</a></p>
				</li>';
			}
