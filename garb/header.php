...
<link rel="icon" href="<?php bloginfo('template_url'); ?>/fav16x16.ico" type="image/x-icon" />
<link rel="shortcut icon" href="<?php bloginfo('template_url'); ?>/fav16x16.ico" type="image/x-icon" />
...
<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url'); ?>/skin/frontend/base/default/css/widgets.css" media="all" />
<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url'); ?>/skin/css/application.css" media="all" />
<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url'); ?>/skin/css/print.css" media="print" />
<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url'); ?>/skin/css/onepagecheckout.css" media="all" />
...
<!--[if lt IE 8]>
<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url'); ?>/skin/css/styles-ie.css" media="all" />
<![endif]-->
<!--[if lt IE 7]>
<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/js/lib/ds-sleight.js"></script>
<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/skin/js/ie6.js"></script>
<![endif]-->
